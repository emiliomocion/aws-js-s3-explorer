...
function SettingsController($scope, SharedService) {
    ...
    $scope.settings = {
        auth: 'auth', region: 'us-east-1', bucket: '', entered_bucket: 'resources.caracolinternacional.com', selected_bucket: 'resources.caracolinternacional.com', view: 'folder', delimiter: '/', prefix: prefix
    };
